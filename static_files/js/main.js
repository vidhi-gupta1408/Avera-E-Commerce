...
$(document).ready(function ($) {
    ...
    // Reset menu state on tab switch or when navigating back
    ...
    function resetMobileMenu() {
        ...
        // Reset hover styles
        $('.main-menu li a').css('color', '');  // Reset the color
    ...
    // Reset the menu if the page visibility changes (page comes into view)
    document.addEventListener('visibilitychange', function () {
        if (document.visibilityState === 'visible') {
            resetMenu();
        }
    ...
    // Optional: Handle resize and reset menu for desktop size
    $(window).resize(function () {
        if ($(window).width() >= 992) {
            resetMenu();
        }
